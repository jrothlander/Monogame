...
internal class GamePadControllers : DrawableGameComponent
{
    ...
    public GamePadControllers(Game game) : base(game)
    {
    }
    ...
    public override void Draw(GameTime gameTime)
    {
        ...
        if (_keyState.IsKeyDown(Keys.F12) && _prevKeyState.IsKeyUp(Keys.F12))
