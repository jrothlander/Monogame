...
namespace Xbox.Galaga.Player
{
    ...
    public class Player
    {
        ...
        private GamePadState _gameState, _prevGameState;
        ...
        public void Update(GameTime gameTime) //, EnemyManager enemyManager)
        {
            ...
            Position.X += Speed * (float)gameTime.ElapsedGameTime.TotalSeconds * _gameState.ThumbSticks.Left.X;
            //Position.Y += Speed * (float)gameTime.ElapsedGameTime.TotalSeconds * _gameState.ThumbSticks.Left.Y;
            ...
            if ( (_gameState.Buttons.A == ButtonState.Pressed && _prevGameState.Buttons.A == ButtonState.Released)   
                || (_keyState.IsKeyDown(Keys.Space) && _prevKeyState.IsKeyUp(Keys.Space)))
            {
