...
namespace Xbox.Galaga.Screens
{
    ...
    public class Screens
    {
        ...
        public void DrawSplashScreen(SpriteBatch spriteBatch, Texture2D spriteSheet, int screenWidth, int screenHeight)
        {
            ...
            int textStart = (int)halfScreenHeight - 300;
            ...
            TextToSpriteHandler.DrawString(spriteBatch, "A or Spacebar to Begin", Color.Aqua, (int)halfScreenWidth, halfFontWidth, textStart + 400, 8, 8);
        }
        ...
        public void DrawResultsScreen(SpriteBatch spriteBatch, Texture2D spriteSheet, int screenWidth, int screenHeight)
        {
            const int halfFontWidth = 4;
            double halfScreenWidth = screenWidth * 0.5;
            double halfScreenHeight = screenHeight * 0.5;
            ...
            TextToSpriteHandler.DrawString(spriteBatch, "game over", Color.Red, (int)halfScreenWidth, halfFontWidth, textStart + 100, 8, 8);

            TextToSpriteHandler.DrawString(spriteBatch, "-- results --", Color.Red, (int)halfScreenWidth, halfFontWidth, textStart + 165, 8, 8);

            TextToSpriteHandler.DrawString(spriteBatch, "shots fired", Color.Yellow, (int)halfScreenWidth - 100, textStart + 200, 8, 8);
            TextToSpriteHandler.DrawString(spriteBatch, GameStatsHandler.ShotsFired.ToString(CultureInfo.InvariantCulture), Color.Yellow, (int)halfScreenWidth + 75, textStart + 200, 8, 8);

            TextToSpriteHandler.DrawString(spriteBatch, "number of hits", Color.Yellow, (int)halfScreenWidth - 100, textStart + 225, 8, 8);
            TextToSpriteHandler.DrawString(spriteBatch, GameStatsHandler.Hits.ToString(CultureInfo.InvariantCulture), Color.Yellow, (int)halfScreenWidth + 75, textStart + 225, 8, 8);

            TextToSpriteHandler.DrawString(spriteBatch, "hit-miss ratio", Color.White, (int)halfScreenWidth - 100, textStart + 250, 8, 8);
            ...
            TextToSpriteHandler.DrawString(spriteBatch, $"{hitMissRatio} %", Color.White, (int)halfScreenWidth + 75, textStart + 250, 8, 8);

            TextToSpriteHandler.DrawString(spriteBatch, "B or Enter to Restart", Color.Aqua, (int)halfScreenWidth, halfFontWidth, textStart + 325, 8, 8);
        }
